...
date: "2021-02-09"
description:
  Create a provisional representation of a user based on existing knowledge
  and assumptions
resources:
  - name: cover
...
8. Tape together the highest scoring quadrants into one consolidated persona and reads it to the group
