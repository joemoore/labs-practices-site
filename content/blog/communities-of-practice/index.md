...
At [Pivotal/Tanzu Labs](https://en.wikipedia.org/wiki/Pivotal_Labs), we work with client organizations to strengthen their software development practices. “Software Development” is typically broken down into several roles or disciplines depending on the organization. Each discipline has its own craft or mastery. There is the mastery of operating a platform, writing software, designing applications, and managing a product, just to name a few.
