...
faqs:
  faq:
    - question: What is Docker?
      answer:
        Docker is an open source container platform that utilizes OS-level virtualization
    ...
    - question: What is a Docker container image?
      answer:
        A Docker container image is a lightweight, isolated, executable software
    ...
    - question: What are Docker pods?
      answer:
        A Docker pod is a similar group of containers with shared namespaces and
        filesystem volumes.
    - question: Can Kubernetes run Docker containers?
      answer:
        <a href='https://tanzu.vmware.com/kubernetes-vs-docker'>Kubernetes can run Docker containers</a> and 'docker build' images, but it
