...
date: 2020-07-29
description:
  Integrate Kafka with MongoDB to create scalable, fault-tolerant messaging
  on Kubernetes
lastmod: "2021-02-05"
...
team:
  - Vikram Vaswani
title:
  Build a Scalable, Fault-Tolerant Messaging Cluster on Kubernetes with Apache
  Kafka and MongoDB
...
- Create a _client.properties_ file with the content below:
