...
date: "2020-05-05"
description:
  Deploy applications to Kubernetes with ArgoCD, a declarative GitOps tool
...
faqs:
  faq:
    - question: How do you install ArgoCD on Kubernetes?
      answer:
        After creating a Kubernetes cluster, ArgoCD can be installed with two
    ...
    - question: What are the benefits of using ArgoCD on Kubernetes?
      answer:
        Because ArgoCD can apply git repository configurations to Kubernetes,
    ...
    - question: How do you install ArgoCD CLI?
      answer:
        On Mac, the ArgoCD CLI can be installed with `brew`, where there is a
    ...
    - question: How do you deploy apps to ArgoCD in Kubernetes?
      answer:
        After Installation of the ArgoCD CLI, to deploy your applications with
    ...
    - question: How do you add a Kubernetes cluster to ArgoCD?
      answer:
        Kubernetes clusters can be added to ArgoCD by installing the proper configuration
    ...
    - question: What is ArgoCD sync?
      answer:
        "“Sync” is the terminology ArgoCD uses to describe the application on
